...
var mainText = new RichText(
  ...
  text: new TextSpan(
    ...
    children: <TextSpan>[
      new TextSpan(text: 'Developed & Maintained \n By team :- \n'),
      new TextSpan(
          text: '\nFamille',
          style: new TextStyle(
...
var midText = Text(
  "For suggestions and requests please feel free to email us !",
            ...
            child: Column(
              ...
              children: <Widget>[
                ...
                SizedBox(
                  width: width * 0.60,
                  child: Image.network(
                      'https://i.kym-cdn.com/photos/images/newsfeed/001/503/249/9e2.jpg'),
                ),
                Padding(
                  padding: const EdgeInsets.all(20.0),
                  child: midText,
